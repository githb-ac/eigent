...
export default function CloseNoticeDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="gap-0 !rounded-xl border-border-subtle-strong !bg-popup-surface p-0 shadow-sm sm:max-w-[600px] border">
        <DialogHeader className="!rounded-t-xl !bg-popup-surface p-md">
          <DialogTitle className="m-0">{t('layout.close-notice')}</DialogTitle>
        </DialogHeader>
        <div className="gap-md bg-popup-bg p-md flex flex-col">
