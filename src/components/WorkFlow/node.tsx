...
export function Node({ id, data }: NodeProps) {
  ...
  return chatStore ? (
    <>
      ...
      >
        <div className="flex w-[342px] shrink-0 flex-col border-y-0 border-l-0 border-r-[0.5px] border-solid border-border-secondary pb-1">
          ...
          <div
            ...
            className={`scrollbar flex flex-col gap-2 overflow-y-auto px-3 duration-500 ease-out animate-in fade-in-0 slide-in-from-bottom-4 ${
